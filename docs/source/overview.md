...
Editor. This page covers how the project is organized and how to launch it for the first time.
...
- **Show Developer Panel** — toggles the Dev button on the in-game HUD, checked in the menu while
  it's visible. With it turned on, pressing **Play** and tapping that button opens a bottom UI bar
  listing every level in the project — tap any entry to jump straight to it, instead of playing
  through every level before it to reach the one you want to test.
